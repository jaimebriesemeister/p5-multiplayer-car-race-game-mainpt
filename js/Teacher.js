class Teacher {
  constructor() {
    this.generateSecretWord = createButton("Gerar Palavra Secreta");
    this.message = createElement("h3");
    this.secretWord = createElement("h3");

    this.nameInput = createInput("").attribute("placeholder", "Nome");
  ...
  handleOnpress() {
    this.generateSecretWord.mousePressed(async () => {
      ...
      this.message.html("Envie sua palavra secreta para o aluno !");
      this.secretWord.html(`Palavra Secreta = ${secret_word}`);
    ...
    this.playButton.mousePressed(() => {
      ...
      this.greeting2.html("Aguardando outros jogadores entrarem ....");
